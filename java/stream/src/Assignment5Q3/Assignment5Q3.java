...
public class Assignment5Q3 {
	...
	public static void main(String[] args) {
		Trader t1= new Trader("venkat", "PUNE");
        Trader t2= new Trader("sai", "MUMBAI");
        Trader t3= new Trader("ram", "DELHI");
        Trader t4= new Trader("kumar", "PUNE");
        Trader t5= new Trader("mnao", "MUBAI");
